...
<template>
  <header v-if="showHero" class="flex items-center justify-center h-[var(--full-header)] md:px-6">
    <div>
      <div class="space-y-2 mb-12 md:mb-14">
        ...
        <div class="text-center">
          <h1 v-if="heroText" id="main-title" class="text-3xl leading-10 font-semibold sm:text-5xl sm:leading-16">
            {{ heroText }}
          </h1>
          ...
          <div class="flex space-x-4 mt-8 justify-center">
            ...
            <AppButton outline v-if="frontmatter.altActionLink && frontmatter.altActionText" size="lg" :href="frontmatter.altActionLink">
